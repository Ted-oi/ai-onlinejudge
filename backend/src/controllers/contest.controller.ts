...
export const getContests = asyncHandler(async (req, res) => {
  ...
  return sendSuccess(res, { contests: result.rows })
})
...
export const createContest = asyncHandler(async (req, res) => {
  ...
  return sendSuccess(res, { contest: result.rows[0] }, 201)
})
...
export const updateContest = asyncHandler(async (req, res) => {
  ...
  return sendSuccess(res, { contest: result.rows[0] })
})
...
export const registerForContest = asyncHandler(async (req, res) => {
  ...
  return sendSuccessWithMessage(res, '注册成功')
})
...
export const getContestStandings = asyncHandler(async (req, res) => {
  ...
  if (registrantsResult.rows.length === 0) {
    return sendSuccess(res, { standings: [], problems: problemIds })
  }
